...
__author__="epasseto"
__date__ ="$11/09/2012 11:02:54$"

# Maximum Centrality
# The centrality algorithm in lecture measured centrality by taking the average
# distance from a node to all the other nodes it can reach.

# Modify this algorithm to return the maximum distance from a node to all the
...
def centrality_max(G, v):
    ...
    print v, "distance:", distance_from_start
