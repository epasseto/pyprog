...
def check_connection(G, v1, v2): #similar to list_component_sizes(G)
    # Return True if v1 is connected to v2 in G or False if otherwise
    marked = {}
